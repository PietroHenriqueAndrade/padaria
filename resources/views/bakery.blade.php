...
<header>
    <div style="display: flex; align-items: center; justify-content: center; gap:40px;">
        ...
        <img src="imagens/logo.jpg" alt="Logo Padaria Aconchego" style="height: 120px;">
